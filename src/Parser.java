...
public class Parser {
	...
	public static void main(String[] args) {
		try {
			...
			// String to = args[1];
			String from =
			"/media/shashank/Windows/Wikipedia/enwiki-latest-pages-articles.xml";
			String to = "/media/shashank/Windows/Wikipedia";
			...
			if (handler.getFilecount() > 0) {
				...
				/*
				 * File towrite = new File(to + "/info.txt"); FileWriter fw; fw
				 * = new FileWriter(towrite, false); BufferedWriter bw = new
				 * BufferedWriter(fw);
				 */
				int filec = 26;
